...
```{r}
balanced_portfolio_returns <- readr::read_csv("balanced.csv")
conservative_portfolio_returns <- readr::read_csv("conservative.csv")
aggressive_portfolio_returns <- readr::read_csv("aggressive.csv")
```
